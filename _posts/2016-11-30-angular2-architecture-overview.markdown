---
layout:     post
title:      "[Angular2] Architecture Overview"
subtitle:   ""
...
代码中的`*ngFor`、`{% raw %}{{hero.name}}{% endraw %}`、`(click)`、`[hero]`和`<hero-detail>`这些都是Angular的[模板语法](https://angular.io/docs/ts/latest/guide/template-syntax.html)。
